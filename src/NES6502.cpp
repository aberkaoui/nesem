...
uint8_t NES6502::ZP0() {
    ...
    // Here, we "shortcut" the page byte reading (which takes time!) and directly assume page
    // zero.
...
uint8_t NES6502::FetchData() {
    ...
    return fetchedData; // In case, for any other function's use as argument or variable as
                        // value
}
